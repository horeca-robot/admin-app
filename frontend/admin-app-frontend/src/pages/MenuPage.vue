    ...
    <div class="page">
        <div class="panel">
            <div class="categories-box">
                ...
                <button :class="selectedCategory === 'archive' ? 'categories last-item last-item-selected' : 'categories last-item'" @click="selectArchivedCategorie">{{text.MenuPage_Archive}}</button>
            </div>
